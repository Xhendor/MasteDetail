...
/**
 * A fragment representing a single Participante detail screen.
 * This fragment is either contained in a {@link ParticipanteListActivity}
 * in two-pane mode (on tablets) or a {@link ParticipanteDetailActivity}
 * on handsets.
 */
